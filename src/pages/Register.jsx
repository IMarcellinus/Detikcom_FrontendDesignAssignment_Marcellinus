...
const Register = () => {
  return (
    <>
      <Header />
      <section className="bg-cover bg-no-repeat bg-register-section sm:h-[500px] h-screen w-full justify-center items-center flex">
        <div className="md:top-60 top-56 absolute text-center w-full">
          <p className="text-white capitalize text-4xl font-bold">registrasi</p>
        </div>
        <div className="bg-white w-full md:w-[640px] top-72 md:h-40 md:top-80 flex flex-col absolute rounded-lg">
          ...
          <div className="px-6 pb-5">
            ...
            <div className="flex items-center pt-4 pb-4">
              ...
              <label className="ml-2 text-sm  text-[#071424]">
                Dengan menekan tombol &quot;Daftar&quot;, Saya menyetujui syarat
