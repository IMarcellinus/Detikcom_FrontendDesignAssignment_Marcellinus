...
const SectionMekanisme = () => {
  return (
    <section className="bg-cover bg-no-repeat bg-mekanisme-section min-h-screen w-full flex justify-center items-center md:py-24 py-20" id="mechanism">
      <div className="md:px-44 w-full h-auto px-2">
