  ...
  return (
    <header className="shadow-md w-full fixed top-0 left-0 z-50">
      <div className="md:flex items-center justify-between bg-[#007CBD] py-2 md:px-10 px-7">
        ...
        <ul
          className={`md:flex md:items-center md:flex-row md:gap-12 md:pb-0 pb-4 absolute md:static bg-blue-400 md:bg-transparent md:z-auto z-[-1] left-0 w-full md:w-auto md:top-0 top-[5.6rem] flex flex-col ${
